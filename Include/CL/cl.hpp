...
# define CL_HPP_USE_DX_INTEROP
#endif
#if !defined(CL_HPP_USE_GL_INTEROP) && defined(USE_GL_INTEROP)
# pragma message("opencl.hpp: USE_GL_INTEROP is deprecated. Define CL_HPP_USE_GL_INTEROP instead")
# define CL_HPP_USE_GL_INTEROP
#endif
...
#include <CL/cl.h>
#include <CL/cl_ext.h>
#if defined(CL_HPP_USE_GL_INTEROP)
#include <CL/cl_gl.h>
#endif
#endif // !__APPLE__
...
// MinGW with compat thread headers: Win32-based once_flag
#include <windows.h>
namespace std {
    struct once_flag { LONG flag = 0; };
    template<typename Callable, typename... Args>
    void call_once(once_flag& flag, Callable&& f, Args&&... args) {
        if (InterlockedCompareExchange(&flag.flag, 1, 0) == 0) {
...
#if defined(CL_USE_DEPRECATED_OPENCL_1_1_APIS) && defined(CL_HPP_USE_GL_INTEROP)
...
#if CL_HPP_TARGET_OPENCL_VERSION >= 120 && defined(CL_HPP_USE_GL_INTEROP)
/*! \class ImageGL
